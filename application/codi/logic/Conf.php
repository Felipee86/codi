    ...
    if (empty(self::$_AConf)) {
      ...
      while (false !== ($dir = readdir($handle))) {
        if ($dir != "." && $dir != ".." && is_dir(CONFIG_PATH . DIRECTORY_SEPARATOR . $dir)) {
          $option = new Zend_Config_Ini(CONFIG_PATH . DIRECTORY_SEPARATOR . $dir . DIRECTORY_SEPARATOR . "module.ini");
      ...
      if (file_exists(CONFIG_PATH . DIRECTORY_SEPARATOR . 'system.ini')) {
        $option_system = new Zend_Config_Ini(CONFIG_PATH . DIRECTORY_SEPARATOR . 'system.ini');
      ...
      if (file_exists(CONFIG_PATH . DIRECTORY_SEPARATOR . 'user.ini')) {
        $option_user = new Zend_Config_Ini(CONFIG_PATH . DIRECTORY_SEPARATOR . 'user.ini');
