...
require_once 'Codi/Class.php';
require_once 'Rendus/Layout/Abstract.php';
require_once 'Rendus/Layout/Content.php';

class Rendus_Layout extends Rendus_Layout_Abstract {
  ...
  private function _setContent()
  {
    ...
    if ($content && Codi_Class::loadContent($content)) {
